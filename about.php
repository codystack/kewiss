...
?>
    ...
    <main class="page-wrapper">
        ...
        <section class="d-flex min-vh-100 overflow-hidden py-5">
                    ...
                    <div class="col-lg-6 mb-4 mb-lg-0 pb-3 pb-lg-0">
                        <div class="parallax mx-auto mx-lg-0" style="max-width: 582px;">
                            <div class="parallax-layer z-3" data-depth="0.1">
                                <div class="position-relative bg-dark mx-auto" style="max-width: 61%; padding: .3125rem; margin-bottom: 9.9%; border-radius: calc(var(--ar-border-radius) * 2.125);">
                                    <div class="position-absolute start-50 translate-middle-x" style="top: 4.4%; width: 85%;">
                                        ...
                                        <img class="rounded-circle" src="assets/img/avatar.jpg" width="35" alt="Avatar">
                                        <div class="fs-xs ps-2" data-bs-theme="light">
                                            <span class="text-nav fw-bold me-1">Oghenekevwe</span>
                            ...
                            <div class="parallax-layer" data-depth="0.3">
                                <img src="assets/img/shape01.svg" alt="Background shape">
                            </div>
                            <div class="parallax-layer z-2" data-depth="-0.1">
                                <img src="assets/img/shape02.svg" alt="Background shape">
                            </div>
                            <div class="parallax-layer" data-depth="-0.15">
                                <img src="assets/img/shape03.svg" alt="Background shape">
                            </div>
                            <div class="parallax-layer z-2" data-depth="-0.25">
                                <img src="assets/img/shape04.svg" alt="Background shape">
                            </div>
                        </div>
                    </div>

                    <div class="col-lg-6 text-center text-lg-start">
                        <h1 class="display-3 pb-3 mb-4"><span class="fw-normal">We’re passionate about</span> solving problems</h1>
                        <div class="row">
                            <div class="col">
                                <p class="mb-0">We’re missionaries, not mercenaries. We optimise for a positive impact on the world, not profits or personal gains next quarter. That means always starting from a customer's needs and working backwards to solutions.</p>
                            </div>
                        </div>
                        <div class="d-sm-flex justify-content-center justify-content-lg-start pt-5 mt-lg-2">
                        <a class="btn btn-lg btn-dark w-100 w-sm-auto mb-2 mb-sm-0 me-sm-1" href="download">Download <i class="ai-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container pb-sm-2 pb-md-3 pb-lg-5 mb-md-3 mb-lg-0">
                ...
                <div class="position-relative mx-auto" style="max-width: 1198px;">
                    <div class="position-relative z-3" data-aos="fade-left" data-aos-duration="600" data-aos-offset="300">
                        <img src="assets/img/about01.png" alt="Image">
                    </div>
                    <div class="position-absolute top-0 start-0 z-2" data-aos="fade-right" data-aos-duration="600" data-aos-offset="300">
                        <img src="assets/img/about02.png" alt="Image">
                    </div>
                    <div class="position-absolute top-0 start-0 z-4" data-aos="zoom-in" data-aos-duration="500" data-aos-offset="300" data-aos-delay="900" data-aos-easing="ease-out-back">
                        <svg class="w-100 h-100 text-info" width="1198" height="693" viewBox="0 0 1198 693" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="position-absolute top-0 start-0" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-aos-delay="600" data-aos-easing="ease-out-back">
                ...
                <div class="row pt-5 mt-md-4">
                    <div class="col col offset-xxl-1 mb-4 mb-md-0">
                        <div class="text-center text-md-start pe-md-4 pe-xl-5 pe-xxl-0">
                        <h2 class="h1 mb-sm-4">We reimagine the way the world moves <br>for the better</h2>
                        <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0">Forget the hustle, ditch the stress - Kewiss Ride is here to power your life, one smooth journey at a time. Imagine skipping the endless wait for taxis, the frustrating search for parking, and the uncertainty of unreliable schedules. Kewiss Ride elevates movement to an art form, placing the freedom of seamless travel right at your fingertips.</p>
                        <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0">Our story is woven with the vibrant threads of progress and convenience. Kewiss Ride was born from a desire to revolutionize the way we move. We see the city as a living tapestry, woven together by countless journeys, each one holding the potential for discovery and connection. And we're the brush that paints those journeys with unmatched ease and efficiency.</p>
                        <hr>
                        <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0 mt-3">Kewiss Ride is more than just a ride-hailing app. We're a tech-powered ecosystem that seamlessly connects riders with a diverse fleet of transportation options. Need a quick zip across town? Our comfortable cars and experienced drivers are ready to whisk you away. Craving a touch of luxury? Opt for our premium car selections, where every ride feels like a first-class experience.</p>
                        <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0">But Kewiss Ride isn't just about getting you from point A to point B. We're also passionate about safety. Every driver undergoes rigorous background checks and training, ensuring you get behind the wheel (or handlebars) of trustworthy and responsible individuals. Real-time tracking and in-app safety features put your peace of mind at the forefront of every journey.</p>
                        <a class="btn btn-lg btn-link px-0" href="contact">
                            More about us
        ...
        <section class="pt-2 mt-lg-3">
            <div class="container">
                <div class="position-relative overflow-hidden rounded-5 px-4 px-sm-5 px-lg-0">
                    <div class="bg-dark rounded-5 position-absolute top-0 start-0 w-100 h-100" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="lg"></div>
                    <div class="row align-items-center position-relative z-2">
                        <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 pb-sm-3 pt-5 py-md-0 py-lg-5" data-aos="fade-up" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="lg">
                            <h2 class="display-3 text-white text-center text-md-start mb-4 mb-lg-5">Download and <br class="d-none d-xxl-inline">Start Moving In Style</h2>
                        ...
                        <div class="col-md-6 col-lg-5 offset-xl-1">
                            ...
                            <div class="d-none d-md-block position-relative mx-auto" style="max-width: 484px;">
                                <div class="position-absolute top-0 start-0 w-100 h-100" data-aos="zoom-in" data-aos-duration="400" data-aos-delay="600" data-aos-offset="300" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                                    <svg class="position-absolute top-0 start-0 w-100 h-100" width="484" height="590" style="color: #a7e92f" viewBox="0 0 484 590" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <img src="assets/img/cta-screens.png" alt="App screens" data-aos="fade-left" data-aos-duration="600" data-aos-delay="200" data-aos-offset="300" data-disable-parallax-down="lg">
                            </div>
                        </div>
                    </div>
                </div>
