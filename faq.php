            ...
            <div class="container pt-5 pb-lg-2 pb-xl-4 py-xxl-5 mt-5">
                <div class="row">
                    <div class="col-md-4 text-center text-md-start">
                        <h2 class="h1">Any questions? <br>Check out the FAQ</h2>
                        <p class="pb-3 pb-sm-4">If you have any questions about Kewiss Ride, go through our frequently asked questions.</p>
                        <div class="d-none d-md-flex justify-content-center">
                            <svg class="ms-n4" style="color: #a7e92f" width="200" height="211" viewBox="0 0 200 211" fill="none" xmlns="http://www.w3.org/2000/svg">
