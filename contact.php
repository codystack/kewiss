    ...
    <main class="page-wrapper">
        ...
        <section class="bg-secondary py-5">
            <div class="container pt-5 pb-lg-2 pb-xl-4 py-xxl-5 mt-5">
                ...
                <p class="fs-lg pb-4 mb-2 mb-sm-3 text-center">Get in touch with us by email or calling us now.</p>
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="pb-1 mb-2">
                                <span class="d-block fs-sm text-body-secondary mb-1">Mon - Sun</span>
                                <div class="d-flex align-items-center">
                                    <span class="text-nav fs-lg fw-medium">6:00AM</span>
                                    <span class="border-top mx-4" style="width: 36px; height: 1px;"></span>
                                    <span class="text-nav fs-lg fw-medium">12:00AM</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="pb-1 mb-2">
                                <span class="d-block fs-sm text-body-secondary mb-1">Main office</span>
                                <a class="nav-link fs-lg p-0" href="mailto:hello@kewiss.com">hello@kewiss.com</a>
                            </li>
                        </ul>
                    </div>
                    </div>
