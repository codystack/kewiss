...
?>
    <main class="page-wrapper">
        ...
        <section class="position-relative pt-md-2 pt-lg-5 pt-xl-5 pb-1 pb-lg-0 pt-5">
            ...
            <div class="jarallax rounded overflow-hidden z-2" data-jarallax data-speed="0.65" style="-webkit-clip-path: url(#shape); clip-path: url(#shape);">
                <div class="d-none d-md-block ratio ratio-21x9">
                    <div class="row position-absolute">
                        <div class="position-relative top-30 col-lg-8 col-xxl-8 ms-5">
                            <h1 class="display-3 text-white text-lg-start">Classy Rides, <br><span style="color: #a7e92f">Every Time.</span></h1>
                        </div>
                    </div>
                </div>
                <div class="d-md-none ratio ratio-16x9"></div>
                <svg class="d-none d-md-block" width="0" height="0" viewBox="0 0 1296 5306">
                <defs>
                    <clipPath id="shape" clipPathUnits="objectBoundingBox" transform="scale(0.0007716049383, 0.001976284585)">
                    <path d="M18 10 306 01.911 0 140.05887 .001  0H1278C1287.94 0 1296 8.05888 1296 18V378C1296 387.941 1287.94 396 1278 396H1008C998.059 396 990 404.059 990 414V488C990 497.941 981.941 506 972 506H18C8.0587 506 0 497.941 0 488V128C0"/>
                    </clipPath>
                </defs>
                </svg>
                
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-10"></span>
                <div class="jarallax-img" style="background-image: url(assets/img/herobg.jpg);"></div>
            </div>
        ...
        <section class="bg-secondary position-relative">
            <div class="bg-dark position-absolute start-0 bottom-0 w-100 d-none d-xl-block" style="height: 920px;"></div>
            <div class="bg-dark position-absolute start-0 bottom-0 w-100 d-none d-lg-block d-xl-none" style="height: 830px;"></div>
            <div class="bg-dark position-absolute start-0 bottom-0 w-100 d-lg-none d-xl-none" style="height: 62%;"></div>
            <div class="bg-black bg-opacity-90 rounded-circle position-absolute start-50 d-none d-lg-block" style="bottom: 220px; width: 480px; height: 480px; margin-left: -240px;" data-aos="zoom-in" data-aos-duration="700" data-aos-delay="200" data-aos-offset="300"></div>
            <div class="container position-relative z-5 mt-2 pb-2 pb-sm-4 pb-lg-5">
                <h1 class="display-3 text-center mx-auto pt-5 my-2 my-sm-4" style="max-width: 680px;">Go wherever, whenever.</h1>
                <svg class="d-block mx-auto" style="color: #a7e92f" width="511" height="40" viewBox="0 0 511 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
                    <div class="col-8 col-lg-4 order-lg-2" style="margin-top: -105px;">
                        <div class="position-lg-sticky top-0 mb-5 pb-sm-2 pb-xl-4" style="padding-top: 110px;">
                            <img class="d-block mx-auto" src="assets/img/search_ride.png" width="322" alt="App screen">
                        </div>
                    </div>
                    ...
                    <!-- Left app sceen -->
                    <img class="d-none d-lg-block rounded-4 ms-auto" src="assets/img/book_ride.png" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
                    ...
                    <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                        <h2 class="h4 text-white mb-2 mb-lg-3">Go any distance</h2>
                        <p class="text-white opacity-80 mb-0">Book rides within the city with Daily, or take a trip to your favourite destinations outside the city.</p>
                    </div>
                    <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-right" data-aos-delay="200" data-aos-offset="250" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                        <h2 class="h4 text-white mb-2 mb-lg-3">Go any duration</h2>
                        <p class="text-white opacity-80 mb-0">Easily plan a day out without having to worry about conveyance with an hour-based package.</p>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
                        ...
                        <!-- Right app screen -->
                        <img class="d-none d-lg-block rounded-4" src="assets/img/call_driver.png" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
                        ...
                        <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-left" data-aos-offset="250" data-aos-delay="400" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <h2 class="h4 text-white mb-2 mb-lg-3">For Riders</h2>
                            <p class="text-white opacity-80 mb-0">We constantly experiment to come up with industry-first features for our riders that eventually become a norm.</p>
                        </div>
                        <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4" style="max-width: 340px;" data-aos="fade-left" data-aos-offset="200" data-aos-delay="600" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <h2 class="h4 text-white mb-2 mb-lg-3">For Drivers</h2>
                            <p class="text-white opacity-80 mb-0">Our drivers get real time stats to help optimize their rides better and earn more, straight from the app.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
            ...
            <div class="col-lg-5 mb-5 mb-lg-0">
                <div class="h1 text-center text-lg-start pb-md-2 pb-xl-0 mb-4 mb-xl-5">Because a fair price is something you can offer, not hope for.</div>

                <div class="d-flex justify-content-center justify-content-lg-start">
                <a class="btn btn-dark btn-lg px-3 py-2 me-3" href="#">
                    <img class="d-dark-mode-none mx-1" src="assets/img/market/appstore-light.svg" width="136" alt="App Store">
                    <img class="d-none d-dark-mode-block mx-1" src="assets/img/market/appstore-dark.svg" width="136" alt="App Store">
                </a>
                <a class="btn btn-dark btn-lg px-3 py-2" href="#">
                    <img class="d-dark-mode-none mx-1" src="assets/img/market/googleplay-light.svg" width="135" alt="Google Play">
                    <img class="d-none d-dark-mode-block mx-1" src="assets/img/market/googleplay-dark.svg" width="135" alt="Google Play">
                </a>
                </div>
            </div>
            <div class="col-lg-7 col-xl-6 offset-xl-1">
                ...
                <div class="col">
                    ...
                    <div class="h3 display-5 mt-1 mb-0">200,000+</div>
                    <div class="fs-lg mb-1">Driver earnings per month</div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex flex-column h-100 bg-danger bg-opacity-10 rounded-3 text-center p-4">
                    <div class="h3 display-5 mt-1 mb-0">5</div>
                    <div class="fs-lg mb-1">Cities</div>
                    </div>
                </div>
                </div>
            </div>
        ...
        <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5 mb-lg-5">
            ...
            <div class="col-md-6 pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
                ...
                <!-- Binded images -->
                <div class="binded-content bg-dark rounded-5">

                <!-- Item -->
                <div class="binded-item active" id="image1">
                    <svg class="d-block position-absolute top-0 start-0 w-100 h-100" style="color: #a7e92f" width="636" height="640" viewBox="0 0 636 640" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <img class="d-block position-relative z-2" src="assets/img/bookride.png" alt="App screen">
                </div>
                ...
                <div class="binded-item" id="image2">
                    ...
                    <img class="d-block position-relative z-2" src="assets/img/calldriver.png" alt="App screen">
                </div>
                ...
                <div class="binded-item" id="image3">
                    ...
                    <img class="d-block position-relative z-2" src="assets/img/receipt.png" alt="App screen">
                </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-5 offset-xl-1">
                ...
                <div class="swiper" data-swiper-options='{
                    ...
                    <div class="swiper-slide" data-swiper-binded="#image1">
                        <h2 class="h1 mb-lg-4">Book or schedule ride</h2>
                        <p class="mb-0">Create an account on the kewiss app, select your pickup and dropp-off location, select from our varities of car and choose the comfort that you deserve.</p>
                    </div>

                    <!-- Item -->
                    <div class="swiper-slide" data-swiper-binded="#image2">
                        <h2 class="h1 mb-lg-4">Call or chat driver</h2>
                        <p class="mb-0">Call or chat with the driver to know his/her location, for security sake also verify the car plate number brfore getting onboard.</p>
                    </div>

                    <!-- Item -->
                    <div class="swiper-slide" data-swiper-binded="#image3">
                        <h2 class="h1 mb-lg-4">Ride history with payment receipt</h2>
                        <p class="mb-0">Make reviews and view your ride history, amount charged. Also note that total amount will be debited from your kewiss wallet at the end of the ride.</p>
                    </div>
                    </div>
                </div>
